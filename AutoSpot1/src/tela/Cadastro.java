 ...
 */
package tela;
import java.time.format.DateTimeParseException; // exeção para o erro no castro quando entrada e saida vazios
...
public class Cadastro extends javax.swing.JInternalFrame {
    ...
    private void bntCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntCadastrarActionPerformed
        ...
        if (txtVaga.getText().isEmpty() || txtPlaca.getText().isEmpty() || txtEntrada.getValue() == null || txtSaida.getValue() == null) {
